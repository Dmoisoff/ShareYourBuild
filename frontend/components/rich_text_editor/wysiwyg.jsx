...
class WYSIWYG extends React.Component {
  ...
  componentDidMount() {
    this.ifr = document.getElementById(
      `theWYSIWYG-${this.state.refNumber}`
    ).contentDocument;
    ...
    if (this.state.instructionBody) {
      this.ifr.getElementsByTagName(
        "body"
      )[0].innerHTML = this.state.instructionBody;
    }
    this.setState({
        ...
        <div id="theRibbon">
          <button
            ...
            onClick={e => {
              ...
              this.setState(
                {
                  instructionBody: this.ifr.getElementsByTagName("body")[0]
                    .innerHTML
                },
                () => this.props.updateDescription(this.state.instructionBody)
              );
